...
namespace LB_7B
{
    [WebService(Namespace = "http://yaniuk.by/")]
    ...
    public class ContactsService : WebService
    {
        ...
        [WebMethod(Description = "Update phone contact")]
        ...
        [WebMethod(Description = "Remove phone contact")]
